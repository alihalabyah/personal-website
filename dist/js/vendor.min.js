...
(function(t,e){"use strict";var n=n||function(n,r){if(!n)throw new Error("A selector must be specified");if(!r.text)throw new Error("TypeWriter needs text to type");var l={element:e.querySelector(n),text:r.text,words:r.words||!1,interval:r.interval||"human",lowerBound:r.lowerBound||30,upperBound:r.upperBound||200},i=function(t,e){return Math.floor(Math.random()*(e-t+1)+t)},o=function(t){return!isNaN(parseFloat(t))&&isFinite(t)},u=function(){return o(l.interval)?l.interval:i(l.lowerBound,l.upperBound)},a=function(e){var n=l.text.length,r=0,i=t.setInterval(function(){r===n?(t.clearInterval(i),e&&e.call(t)):(l.element.innerHTML+=l.text[r],r++)},u.call())},c=function(t){var e=l.text.length,n=0;s(e,n,t)},s=function(e,n,r){if(0===e)return r&&r.call(t);var i,o=u.call();l.element.innerHTML+=l.text[n],i=setTimeout(function(){e--,n++,s(e,n,r)},o)},f=function(e){var n=l.text.split(" "),r=n.length,i=0,o=t.setInterval(function(){i===r?(t.clearInterval(o),e&&e.call(t)):(l.element.innerHTML+=n[i]+" ",i++)},u.call())};this.type=function(t){l.words?f(t):o(l.interval)?a(t):c(t)}};this.TypeWriter=n}).call(this,window,document);
!function(t,n){"function"==typeof define&&define.amd?define(["exports"],function(){n(t)}):n("object"==typeof exports?exports:t)}(this,function(t){"use strict";function n(t){var n=["path","line"],e=n.reduce(function(n,e){return n+t+" "+e+", "},"");return e.slice(0,-2)}function e(t){return this instanceof e?("string"==typeof t&&(t={selector:t}),t.selector?(this.opts=t,this.selector=t.selector,this.duration=t.duration||500,this.easing=s[t.easing]||s.easeInOutCubic,this.paths=this.getPaths(),this.setInitialStyles(),void(this.id=!1)):this.error("A selector needs to be specified")):new e(t)}function i(t,n,e){this.el=t,this.length=t.getTotalLength(),this.duration=n,this.easing=e,this.animationStart=null,this.animationStarted=!1}function a(t,n,e){this.el=t,this.length=r(t),this.duration=n,this.easing=e,this.animationStart=null,this.animationStarted=!1}function r(t){var n=t.getAttribute("x1"),e=t.getAttribute("x2"),i=t.getAttribute("y1"),a=t.getAttribute("y2");return Math.sqrt(Math.pow(n-e,2)+Math.pow(i-a,2))}var o=0;window.requestAnimationFrame=window.requestAnimationFrame||window.mozRequestAnimationFrame||window.webkitRequestAnimationFrame||window.msRequestAnimationFrame,window.cancelAnimationFrame=window.cancelAnimationFrame||window.mozCancelAnimationFrame,window.requestAnimationFrame||(window.requestAnimationFrame=function(t){var n=(new Date).getTime(),e=Math.max(0,16-(n-o)),i=window.setTimeout(function(){t(n+e)},e);return o=n+e,i}),window.cancelAnimationFrame||(window.cancelAnimationFrame=function(t){clearTimeout(t)});var s={linear:function(t){return t},easeInQuad:function(t){return t*t},easeOutQuad:function(t){return t*(2-t)},easeInOutQuad:function(t){return.5>t?2*t*t:-1+(4-2*t)*t},easeInCubic:function(t){return t*t*t},easeOutCubic:function(t){return--t*t*t+1},easeInOutCubic:function(t){return.5>t?4*t*t*t:(t-1)*(2*t-2)*(2*t-2)+1},easeInQuart:function(t){return t*t*t*t},easeOutQuart:function(t){return 1- --t*t*t*t},easeInOutQuart:function(t){return.5>t?8*t*t*t*t:1-8*--t*t*t*t},easeInQuint:function(t){return t*t*t*t*t},easeOutQuint:function(t){return 1+--t*t*t*t*t},easeInOutQuint:function(t){return.5>t?16*t*t*t*t*t:1+16*--t*t*t*t*t}};e.prototype.error=function(t){console.log("Walkway error: "+t)},e.prototype.getPaths=function(){var t=this,e=n(this.selector),r=document.querySelectorAll(e);return r=Array.prototype.slice.call(r),r.map(function(n){return"path"===n.tagName?new i(n,t.duration,t.easing):"line"===n.tagName?new a(n,t.duration,t.easing):void 0})},e.prototype.setInitialStyles=function(){this.paths.forEach(function(t){t.el.style.strokeDasharray=t.length+" "+t.length,t.el.style.strokeDashoffset=t.length})},e.prototype.draw=function(t){var n,e=this.paths.length;if(0===e)return t&&"function"==typeof t&&t(),window.cancelAnimationFrame(this.id);for(;e--;){n=this.paths[e];var i=n.update();i&&this.paths.splice(e,1)}this.id=window.requestAnimationFrame(this.draw.bind(this,t))},i.prototype.update=function(){this.animationStarted||(this.animationStart=Date.now(),this.animationStarted=!0);var t=this.easing((Date.now()-this.animationStart)/this.duration),n=Math.ceil(this.length*(1-t));return this.el.style.strokeDashoffset=0>n?0:Math.abs(n),t>=1?!0:!1},a.prototype.update=function(){this.animationStarted||(this.animationStart=Date.now(),this.animationStarted=!0);var t=this.easing((Date.now()-this.animationStart)/this.duration),n=Math.ceil(this.length*(1-t));return this.el.style.strokeDashoffset=0>n?0:Math.abs(n),t>=1?!0:!1},t.Walkway=e});
